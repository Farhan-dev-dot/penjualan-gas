            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="card shadow-sm">
                    <div class="card-body p-4">
                        <h1 class="h4 fw-bold text-center mb-2">Konfirmasi Login Google</h1>
                        <p class="small text-muted text-center mb-4">
                            ...
                            untuk mengonfirmasi login Anda.
                        </p>
                        ...
                        <form method="POST" action="{{ route('google.confirm.submit') }}">
                            @csrf
                        ...
                        <form method="POST" action="{{ route('google.confirm.resend') }}" class="mt-3">
                            @csrf
